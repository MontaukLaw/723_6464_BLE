...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOE, SW_IN_S1_1_Pin|SW_IN_S3_1_Pin|SW_IN_S2_1_Pin|SW_IN_EN_1_Pin
                          |SW_IN_S0_2_Pin|VOUT_23_Pin|VOUT_24_Pin|VOUT_25_Pin
                          |VOUT_26_Pin|VOUT_27_Pin|VOUT_28_Pin|VOUT_29_Pin
                          |VOUT_30_Pin|VOUT_31_Pin|SW_IN_S0_1_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOF, SW_IN_EN_2_Pin|SW_IN_S0_3_Pin|SW_IN_S1_3_Pin|SW_IN_S3_3_Pin
                          |SW_IN_S2_3_Pin|SW_IN_EN_3_Pin|SW_IN_S0_4_Pin|SW_IN_S1_4_Pin
                          |SW_IN_S3_4_Pin|SW_IN_S2_4_Pin|VOUT_16_Pin|VOUT_17_Pin
                          |VOUT_18_Pin|VOUT_19_Pin|VOUT_20_Pin, GPIO_PIN_RESET);
  ...
  HAL_GPIO_WritePin(GPIOB, VOUT_13_Pin|VOUT_14_Pin|VOUT_15_Pin|VOUT_32_Pin
                          ...
                          |VOUT_37_Pin|FOR_TEST2_Pin|FOR_TEST1_Pin, GPIO_PIN_RESET);
  ...
  HAL_GPIO_WritePin(GPIOD, VOUT_38_Pin|VOUT_39_Pin|VOUT_40_Pin|VOUT_41_Pin
                          ...
                          |LED_R_Pin|LED_G_Pin|LED_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : SW_IN_S1_2_Pin SW_IN_S3_2_Pin SW_IN_S2_2_Pin VOUT_5_Pin
                           VOUT_4_Pin VOUT_3_Pin VOUT_11_Pin VOUT_12_Pin
                           VOUT_53_Pin VOUT_54_Pin VOUT_55_Pin VOUT_56_Pin
                           VOUT_59_Pin VOUT_60_Pin VOUT_61_Pin */
  GPIO_InitStruct.Pin = SW_IN_S1_2_Pin|SW_IN_S3_2_Pin|SW_IN_S2_2_Pin|VOUT_5_Pin
                          |VOUT_4_Pin|VOUT_3_Pin|VOUT_11_Pin|VOUT_12_Pin
                          |VOUT_53_Pin|VOUT_54_Pin|VOUT_55_Pin|VOUT_56_Pin
                          |VOUT_59_Pin|VOUT_60_Pin|VOUT_61_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  ...
  /*Configure GPIO pins : SW_IN_EN_2_Pin SW_IN_S0_3_Pin SW_IN_S1_3_Pin SW_IN_S3_3_Pin
                           SW_IN_S2_3_Pin SW_IN_EN_3_Pin SW_IN_S0_4_Pin SW_IN_S1_4_Pin
                           SW_IN_S3_4_Pin SW_IN_S2_4_Pin VOUT_16_Pin VOUT_17_Pin
                           VOUT_18_Pin VOUT_19_Pin VOUT_20_Pin */
